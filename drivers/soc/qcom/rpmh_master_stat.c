				...
				const char *name)
{
	 ...
	 */
/*2020.04.27 edit longcheer fengxingqiang "Increase the hibernation info of the rpmh subsystem" satrt*/
...
/*2020.04.27 edit longcheer fengxingqiang "Increase the hibernation info of the rpmh subsystem" end*/
